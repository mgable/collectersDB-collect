...
(function(){
	...
	function _init(){
		util.init();
		util.logger.log({searchIndex: util.getSearchHostIndex(), dynamoEndpoint: util.getDynamoEndpoint(), searchIndexHost: util.getSearchHostPath(), category: util.getCurrentCategory() }) ;
	}
