...
(function(){
	...
	var currentCategory,
		...
		searchHostIndex = program.test ? "test-" + config.searchHostIndex : config.searchHostIndex,
	...
	function getDynamoEndpoint(){
		return config.aws.dynamo.endpoint;
	}
	...
	exports.program = program;
	exports.init = init;
	exports.getDynamoEndpoint = getDynamoEndpoint;
